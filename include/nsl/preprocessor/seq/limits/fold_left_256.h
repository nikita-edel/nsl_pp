...
#
# ifndef NSL_PREPROCESSOR_SEQ_FOLD_LEFT_256_H
# define NSL_PREPROCESSOR_SEQ_FOLD_LEFT_256_H
#
# define NSL_PP_SEQ_FOLD_LEFT_CHECK_NSL_PP_SEQ_FOLD_LEFT_I_0(op, st, ss, sz) 0
...
#
# define NSL_PP_SEQ_FOLD_LEFT_0(op, st, ss) NSL_PP_SEQ_FOLD_LEFT_I_0(op, st, ss, NSL_PP_SEQ_SIZE(ss))
...
#
# define NSL_PP_SEQ_FOLD_LEFT_I_0(op, st, ss, sz) NSL_PP_IF(NSL_PP_DEC(sz), NSL_PP_SEQ_FOLD_LEFT_I_1, NSL_PP_SEQ_FOLD_LEFT_F)(op, op(1, st, NSL_PP_SEQ_HEAD(ss)), NSL_PP_SEQ_TAIL(ss), NSL_PP_DEC(sz))
