...
#
# ifndef BOOST_PREPROCESSOR_LIST_FOLD_RIGHT_H
# define BOOST_PREPROCESSOR_LIST_FOLD_RIGHT_H
#
...
#    include <boost/preprocessor/list/detail/edg/fold_right.h>
# else
#    include <boost/preprocessor/list/detail/fold_right.h>
# endif
#
# else
#
