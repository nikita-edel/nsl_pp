...
#
# ifndef BOOST_PREPROCESSOR_SEQ_REST_N_H
# define BOOST_PREPROCESSOR_SEQ_REST_N_H
#
...
# include <boost/preprocessor/seq/detail/is_empty.h>
# include <boost/preprocessor/seq/detail/split.h>
