...
#
# ifndef BOOST_PREPROCESSOR_SEQ_DETAIL_BINARY_TRANSFORM_H
# define BOOST_PREPROCESSOR_SEQ_DETAIL_BINARY_TRANSFORM_H
#
...
# include <boost/preprocessor/variadic/detail/is_single_return.h>
#
